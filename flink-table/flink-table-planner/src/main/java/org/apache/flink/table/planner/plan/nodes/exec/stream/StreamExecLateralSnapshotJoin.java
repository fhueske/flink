...
public class StreamExecLateralSnapshotJoin extends ExecNodeBase<RowData>
    ...
    public StreamExecLateralSnapshotJoin(
            ...
            @JsonProperty(FIELD_NAME_LOAD_COMPLETED_TIME) @Nullable Long loadCompletedTime,
    ...
    private GeneratedJoinCondition generateJoinCondition(
        ...
        return FunctionCodeGenerator.generateJoinCondition(
                ctx,
                "LateralSnapshotJoinConditionFunction",
                body,
                CodeGenUtils.DEFAULT_INPUT1_TERM(),
                CodeGenUtils.DEFAULT_INPUT2_TERM());
    }
